...
const numberFormatter = Intl.NumberFormat("no-NB", { style: "currency", currency: "NOK" });

export function BankAccountCard(props: BankAccoundCardProps) {
  return <div className="bg-seniorBankLightBlue w-full flex mx-24 justify-between border-4 p-2 border-white rounded-3xl px-8 py-4">
