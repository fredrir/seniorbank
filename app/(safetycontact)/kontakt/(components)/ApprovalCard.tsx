...
const ApprovalCard = ({
  ...
  return (
    <div className="mb-4 rounded-lg bg-[#F2F2F9] p-6 shadow-sm">
      ...
      <div className="mb-4">
        <label className="mb-1 block font-medium text-[#002776]">Konto:</label>
      ...
      <div className="flex gap-6">
        <button className="w-1/3 rounded-xl border-2 border-[#002776] bg-inherit py-1 text-lg text-[#002776] hover:bg-blue-50">
          Avis
        </button>
        <button className="w-2/3 rounded-xl bg-[#002776] py-1 text-lg text-white hover:bg-blue-900">
          Godkjenn
        </button>
      </div>
    </div>
